...
class CreateInterviewBloc extends Bloc<CreateInterviewEvent, CreateInterviewState> {
  final InterviewRepository interviewRepository;
  CreateInterviewBloc(this.interviewRepository) : super(CreateInterviewInitial()) {
